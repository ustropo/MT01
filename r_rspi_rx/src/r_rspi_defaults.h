...
#define RSPI_SPCMD_DEF        (RSPI_SPCMD_CPHA_DEF | RSPI_SPCMD_CPOL_DEF | RSPI_SPCMD_BRDV_DEF | RSPI_SPCMD_SSLA_DEF | RSPI_SPCMD_SSLKP_DEF | RSPI_SPCMD_SPB_DEF | RSPI_SPCMD_LSBF_DEF | RSPI_SPCMD_SPNDEN_DEF \
