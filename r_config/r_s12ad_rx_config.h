...
#define ADC_CFG_PGA_GAIN    (0)     // 1.8V <= AVcc0 <= 2.7V; default; good for all actual voltages
//#define ADC_CFG_PGA_GAIN    (1)     // 2.7V <= AVcc0 <= 3.6V
//#define ADC_CFG_PGA_GAIN    (2)     // 3.6V <= AVcc0 <= 5.5V
//#define ADC_CFG_PGA_GAIN    (3)     // 4.5V <= AVcc0 <= 5.5V
