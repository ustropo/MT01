...
/*#define USB_BUSWAIT       (*((REGP*)(USB_BASE+0x02))) */
...
//#define USB_MBW_0               (0x0400u)   /* b10: Maximum bit width for FIFO access *//* For USB0 */
//#define USB_MBW_1               (0x0C00u)   /* b10: Maximum bit width for FIFO access *//* For USBHS */
...
//#define USB_DTLN_0              (0x01FFu)   /* b8-0: FIFO data length *//* For USB0 */
//#define USB_DTLN_1              (0x0FFFu)   /* b11-0: FIFO data length *//* For USBHS */
...
/* PHYSET */
/*#define USB_PHYSET        (*((REGP*)(USB_BASE+0x3E))) */
...
/*#define USB_DVCHGR        (*((REGP*)(USB_BASE+0x4E))) */
...
//#define USB_MXPS_0              (0x01FFu)   /* b8-0: Maxpacket size *//* For USB0 */
//#define USB_MXPS_1              (0x07FFu)   /* b10-0: Maxpacket size *//* For USBHS */
...
/* PHYSLEW */
/*#define USB_PHYSLEW       (*((REGP*)(USB_BASE+0xF0))) */
...
/* DPUSR0R */
/*#define USB_DPUSR0R       (*((REGP*)(USB_BASE+0x400))) */
...
/* DPUSR1R */
/*#define USB_DPUSR1R       (*((REGP*)(USB_BASE+0x404))) */
...
/* PL1CTRL1 */
/*#define USB_PL1CTRL1      (*((REGP*)(USB_BASE+0x544))) */
...
/* PL1CTRL2 */
/*#define USB_PL1CTRL2      (*((REGP*)(USB_BASE+0x546))) */
#define USB_HIRDMON             (0x0F00u)   /* b12: RWE monitor bit */
#define USB_RWEMON              (0x1000u)   /* b11-8: HIRD monitor bit */


/* Host L1 Control Register 1 */
/* HL1CTRL1 */
/*#define USB_HL1CTRL1      (*((REGP*)(USB_BASE+0x548))) */
...
/* PHYTRIM2 */
/*#define USB_PHYTRIM2      (*((REGP*)(USB_BASE+0x552))) */
...
/* DPUSR0R */
/*#define USB_DPUSR0R       (*((REGP*)(USB_BASE+0x560))) */
...
/* DPUSR1R */
/*#define USB_DPUSR1R       (*((REGP*)(USB_BASE+0x564))) */
