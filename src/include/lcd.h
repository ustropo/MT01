...
extern void ut_lcd_output_mov_mode(bool torch,const char* title[3],const char* textX,const char* textY,const char* textZ);
extern void ut_lcd_output_plasma_mode(bool torch,const char* title[6],const char* textX,const char* textY,const char* textZ);
