...
#ifndef xio_command_h
#define xio_command_h
...
int xio_gets_command(xioDev_t *d, char *buf, const int size);		// read string from program memory
int xio_getc_command(FILE *stream);									// get a character from PROGMEM
