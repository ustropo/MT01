...
***********************************************************************************************************************/
/**********************************************************************************************************************
* File Name    : r_s12ad_rx110_rx111_if.h
* Description  : 12-bit A/D Converter driver interface file for RX110/111.
***********************************************************************************************************************
* History : DD.MM.YYYY Version Description
*           22.02.2014 1.00    Initial Release.
***********************************************************************************************************************/

#ifndef S12AD_RX110_RX111_IF_H
#define S12AD_RX110_RX111_IF_H
...
#ifdef BSP_MCU_RX110
#define ADC_SST_CNT_MIN     (7)     // minimum sampling state count
#else
...
typedef struct st_adc_time
{
    ...
    uint8_t         num_states;     // 7-255; default=20; ch8-15 use the same value
} adc_time_t;
