...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_s12ad_rx110_rx111.c
* Description  : ROM tables and support code for RX110/111 devices.
***********************************************************************************************************************/
/**********************************************************************************************************************
...
#include "r_s12ad_rx110_rx111_if.h"
                   ...
                   void         (* const  p_callback)(void *p_args))
{
    ...
    if ((mode >= ADC_MODE_MAX)
     ...
     || ((p_cfg->conv_speed != ADC_CONVERT_SPEED_NORM) && (p_cfg->conv_speed != ADC_CONVERT_SPEED_HI))
